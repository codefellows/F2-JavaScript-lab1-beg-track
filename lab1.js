...
assert('monkey' === 'monkey', 'monkey equals monkey - this assert will pass.');
assert('monkey' === 'zebra', 'this is an example of a failing assertion. Monkey does not equal zebra.');
...
else if (randomPick < 0.49) {
  nextAnimal = favoriteAnimals[1];
}
else if (randomPick < 0.74) {
  nextAnimal = favoriteAnimals[2];
}
else { nextAnimal = favoriteAnimals[3];
}
