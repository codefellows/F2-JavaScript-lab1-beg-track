...
assert('zebra' === 'zebra', 'Zebra = Zebra - this assert passes!');
assert('alligators' > 'giraffes', 'False. Alligators are not better than giraffes.');
...
var arraySent1 = sentence1.split(' ');
for (var i = 0; i < arraySent1.length; i++) {
  arraySent1[i] = 'chirp';
}
sentence1 = arraySent1.join(' ') + '.';
console.log(sentence1);

// TODO: part #2: use a while or do-while loop to replace the words in sentence 2
// with 'chirp' (10 points)

var arraySent2 = sentence2.split(' ');
for (var i = 0; i < arraySent2.length; i++) {
  arraySent2[i] = 'chirp';
}
sentence2 = arraySent2.join(' ') + '.';
...
assert(animalExhibitStats.mostPopular === 'Lucky the Emperor Penguin', 'this is the most popular exihibit. Lets go to that one!');
