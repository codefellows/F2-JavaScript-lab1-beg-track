...
// assert(2 === 1, 'this is an example of a failing assertion. 1 does not equal 2.');
...
assert('zebras'.length === 6, 'zebras is 6 letters long.');
assert('cats'.length > 'elephants'.length, 'cats are not longer than elephants, and neither is the word \'cats\' longer than the word \'elephants\'.');
...
var nextAnimal = favoriteAnimals[getRandomInt(0, 3)];
...
assert(animalExhibitStats.mostPopular === 'Lucky the Emperor Penguin', 'Lucky always wins. You always lose.');
